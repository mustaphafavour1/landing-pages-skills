...
2. The ink-stamp headline mechanism and the shipping-manifest list are both strong, specific, and freshly logged (`concept-gallery.md`, `taste-rules.md`, `section-bank.csv` SEC-13) — available for reuse on a future builder/founder-facing brief, but don't reach for them on something without a real "proof / delivered / official" story, or they'll read as arbitrary decoration.
